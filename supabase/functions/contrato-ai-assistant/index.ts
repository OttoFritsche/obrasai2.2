...
Responda de forma profissional, prática e adequada à construção civil brasileira.`
      ...
      console.error('❌ Erro interno na função contrato-ai-assistant:', error)
      return new Response(JSON.stringify({ erro: 'Erro interno na função contrato-ai-assistant', detalhes: String(error) }), { status: 500 })
    }
  })
} catch (fatalErr) {
